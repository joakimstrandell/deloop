 ...
 *
 * Note: packages/ui/src/components/ uses the `Component/index.tsx`
 * directory convention. Discovery also picks up flat sibling files, so
 * we drop the ephemeral fixture directly into the components/ folder
 * (no risk of conflicting with a directory-form component name).
 *
